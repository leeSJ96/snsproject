...
class HistorySubActivity: AppCompatActivity() , IHomeRecyclerview  {
...
//        Log.d(FirebaseAuth.getInstance().currentUser?.uid.toString(), "로그히스토리받기 ")
        ...
        historysubItemBinding?.viewrvsub?.layoutManager = GridLayoutManager(this, 3)
        Log.d(TAG, "로그  히스토리서브 레이아웃매니저: ")

        setContentView(historysubItemBinding!!.root)
    ...
    inner class HistorySubRecyclerviewAdapter(myRecyclerviewInterface: IHomeRecyclerview) :
            ...
            firestore?.collection("images")?.whereEqualTo("uid", uid)
                ?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                    ...
                    for (snapshot in querySnapshot.documents) {
                        ...
                        Log.d(TAG, "contentsize: ${contentDTO.size} ")
        ...
        inner class CustomViewHolder(
            ...
            //인터페이스
            private var myRecyclerviewInterface: IHomeRecyclerview
